...
$(_a1c).textbox("destroy");
};
function _a1e(_a1f){
var _a20=$.data(_a1f,"combo").panel;
if(_a20.is(":visible")){
var _a21=_a20.combo("combo");
_a22(_a21);
if(_a21!=_a1f){
$(_a1f).combo("showPanel");
}
}else{
var p=$(_a1f).closest("div.combo-p").children(".combo-panel");
$("div.combo-panel:visible").not(_a20).not(p).panel("close");
$(_a1f).combo("showPanel");
}
$(_a1f).combo("textbox").focus();
};
function _a12(_a23){
$(_a23).find(".combo-f").each(function(){
...
function _a24(e){
var _a25=e.data.target;
var _a26=$.data(_a25,"combo");
var opts=_a26.options;
if(!opts.editable){
_a1e(_a25);
}else{
var p=$(_a25).closest("div.combo-p").children(".combo-panel");
$("div.combo-panel:visible").not(p).each(function(){
var _a27=$(this).combo("combo");
if(_a27!=_a25){
_a22(_a27);
}
});
...
function _a28(e){
var _a29=e.data.target;
var t=$(_a29);
var _a2a=t.data("combo");
var opts=t.combo("options");
_a2a.panel.panel("options").comboTarget=_a29;
switch(e.keyCode){
case 38:
opts.keyHandler.up.call(_a29,e);
break;
case 40:
opts.keyHandler.down.call(_a29,e);
break;
case 37:
opts.keyHandler.left.call(_a29,e);
break;
case 39:
opts.keyHandler.right.call(_a29,e);
break;
case 13:
e.preventDefault();
opts.keyHandler.enter.call(_a29,e);
return false;
case 9:
case 27:
_a22(_a29);
...
if(opts.editable){
if(_a2a.timer){
clearTimeout(_a2a.timer);
}
_a2a.timer=setTimeout(function(){
var q=t.combo("getText");
if(_a2a.previousText!=q){
_a2a.previousText=q;
t.combo("showPanel");
opts.keyHandler.query.call(_a29,q,e);
t.combo("validate");
}
},opts.delay);
}
...
var _a2e=_a2d.combo;
var _a2f=_a2d.panel;
var opts=$(_a2c).combo("options");
var _a30=_a2f.panel("options");
_a30.comboTarget=_a2c;
if(_a30.closed){
_a2f.panel("panel").show().css({zIndex:($.fn.menu?$.fn.menu.defaults.zIndex++:($.fn.window?$.fn.window.defaults.zIndex++:99)),left:-999999});
_a2f.panel("resize",{width:(opts.panelWidth?opts.panelWidth:_a2e._outerWidth()),height:opts.panelHeight});
_a2f.panel("panel").hide();
_a2f.panel("open");
}
(function(){
if(_a30.comboTarget==_a2c&&_a2f.is(":visible")){
_a2f.panel("move",{left:_a31(),top:_a32()});
setTimeout(arguments.callee,200);
}
})();
function _a31(){
var left=_a2e.offset().left;
if(opts.panelAlign=="right"){
left+=_a2e._outerWidth()-_a2f._outerWidth();
}
if(left+_a2f._outerWidth()>$(window)._outerWidth()+$(document).scrollLeft()){
left=$(window)._outerWidth()+$(document).scrollLeft()-_a2f._outerWidth();
}
if(left<0){
left=0;
}
...
function _a32(){
var top=_a2e.offset().top+_a2e._outerHeight();
if(top+_a2f._outerHeight()>$(window)._outerHeight()+$(document).scrollTop()){
top=_a2e.offset().top-_a2f._outerHeight();
}
if(top<$(document).scrollTop()){
top=_a2e.offset().top+_a2e._outerHeight();
}
return top;
};
};
function _a22(_a33){
var _a34=$.data(_a33,"combo").panel;
_a34.panel("close");
};
function _a35(_a36,text){
var _a37=$.data(_a36,"combo");
var _a38=$(_a36).textbox("getText");
if(_a38!=text){
$(_a36).textbox("setText",text);
}
_a37.previousText=text;
};
function _a39(_a3a){
var _a3b=$.data(_a3a,"combo");
var opts=_a3b.options;
var _a3c=$(_a3a).next();
var _a3d=[];
_a3c.find(".textbox-value").each(function(){
_a3d.push($(this).val());
});
if(opts.multivalue){
return _a3d;
}else{
return _a3d.length?_a3d[0].split(opts.separator):_a3d;
}
};
function _a3e(_a3f,_a40){
var _a41=$.data(_a3f,"combo");
var _a42=_a41.combo;
var opts=$(_a3f).combo("options");
if(!$.isArray(_a40)){
_a40=_a40.split(opts.separator);
}
var _a43=_a39(_a3f);
_a42.find(".textbox-value").remove();
if(_a40.length){
if(opts.multivalue){
...
_a44(_a40.join(opts.separator));
}
}
function _a44(_a45){
var name=$(_a3f).attr("textboxName")||"";
var _a46=$("<input type=\"hidden\" class=\"textbox-value\">").appendTo(_a42);
_a46.attr("name",name);
if(opts.disabled){
_a46.attr("disabled","disabled");
}
_a46.val(_a45);
};
var _a47=(function(){
if(_a43.length!=_a40.length){
return true;
}
for(var i=0;i<_a40.length;i++){
if(_a40[i]!=_a43[i]){
...
if(_a47){
$(_a3f).val(_a40.join(opts.separator));
if(opts.multiple){
opts.onChange.call(_a3f,_a40,_a43);
}else{
opts.onChange.call(_a3f,_a40[0],_a43[0]);
}
$(_a3f).closest("form").trigger("_change",[_a3f]);
}
};
function _a48(_a49){
var _a4a=_a39(_a49);
...
function _a4e(_a4f){
var opts=$.data(_a4f,"combo").options;
var _a50=opts.onChange;
opts.onChange=function(){
};
if(opts.multiple){
_a3e(_a4f,opts.value?opts.value:[]);
}else{
_a4b(_a4f,opts.value);
}
opts.onChange=_a50;
};
$.fn.combo=function(_a51,_a52){
if(typeof _a51=="string"){
var _a53=$.fn.combo.methods[_a51];
if(_a53){
return _a53(this,_a52);
}else{
return this.textbox(_a51,_a52);
}
}
_a51=_a51||{};
return this.each(function(){
var _a54=$.data(this,"combo");
if(_a54){
$.extend(_a54.options,_a51);
if(_a51.value!=undefined){
_a54.options.originalValue=_a51.value;
}
}else{
_a54=$.data(this,"combo",{options:$.extend({},$.fn.combo.defaults,$.fn.combo.parseOptions(this),_a51),previousText:""});
if(_a54.options.multiple&&_a54.options.value==""){
_a54.options.originalValue=[];
}else{
_a54.options.originalValue=_a54.options.value;
}
}
_a13(this);
_a4e(this);
...
return _a39(jq[0]);
},setValues:function(jq,_a55){
return jq.each(function(){
_a3e(this,_a55);
});
},getValue:function(jq){
return _a48(jq[0]);
},setValue:function(jq,_a56){
return jq.each(function(){
_a4b(this,_a56);
});
}};
$.fn.combo.parseOptions=function(_a57){
var t=$(_a57);
return $.extend({},$.fn.textbox.parseOptions(_a57),$.parser.parseOptions(_a57,["separator","panelAlign",{panelWidth:"number",hasDownArrow:"boolean",delay:"number",reversed:"boolean",multivalue:"boolean",selectOnNavigation:"boolean"},{panelMinWidth:"number",panelMaxWidth:"number",panelMinHeight:"number",panelMaxHeight:"number"}]),{panelHeight:(t.attr("panelHeight")=="auto"?"auto":parseInt(t.attr("panelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined)});
};
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_a24,keydown:_a28,paste:_a28,drop:_a28},panelWidth:null,panelHeight:200,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",reversed:false,multiple:false,multivalue:true,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
},onChange:function(_a58,_a59){
}});
})(jQuery);
(function($){
function _a5a(_a5b,_a5c){
var _a5d=$.data(_a5b,"combobox");
return $.easyui.indexOfArray(_a5d.data,_a5d.options.valueField,_a5c);
};
function _a5e(_a5f,_a60){
var opts=$.data(_a5f,"combobox").options;
var _a61=$(_a5f).combo("panel");
var item=opts.finder.getEl(_a5f,_a60);
if(item.length){
if(item.position().top<=0){
var h=_a61.scrollTop()+item.position().top;
_a61.scrollTop(h);
}else{
if(item.position().top+item.outerHeight()>_a61.height()){
var h=_a61.scrollTop()+item.position().top+item.outerHeight()-_a61.height();
_a61.scrollTop(h);
}
}
}
_a61.triggerHandler("scroll");
};
function nav(_a62,dir){
var opts=$.data(_a62,"combobox").options;
var _a63=$(_a62).combobox("panel");
var item=_a63.children("div.combobox-item-hover");
if(!item.length){
item=_a63.children("div.combobox-item-selected");
}
item.removeClass("combobox-item-hover");
var _a64="div.combobox-item:visible:not(.combobox-item-disabled):first";
var _a65="div.combobox-item:visible:not(.combobox-item-disabled):last";
if(!item.length){
item=_a63.children(dir=="next"?_a64:_a65);
}else{
if(dir=="next"){
item=item.nextAll(_a64);
if(!item.length){
item=_a63.children(_a64);
}
}else{
item=item.prevAll(_a64);
if(!item.length){
item=_a63.children(_a65);
}
}
}
if(item.length){
item.addClass("combobox-item-hover");
var row=opts.finder.getRow(_a62,item);
if(row){
$(_a62).combobox("scrollTo",row[opts.valueField]);
if(opts.selectOnNavigation){
_a66(_a62,row[opts.valueField]);
}
}
}
};
function _a66(_a67,_a68,_a69){
var opts=$.data(_a67,"combobox").options;
var _a6a=$(_a67).combo("getValues");
if($.inArray(_a68+"",_a6a)==-1){
if(opts.multiple){
_a6a.push(_a68);
}else{
_a6a=[_a68];
...
function _a6c(_a6d,_a6e){
var opts=$.data(_a6d,"combobox").options;
var _a6f=$(_a6d).combo("getValues");
var _a70=$.inArray(_a6e+"",_a6f);
if(_a70>=0){
_a6f.splice(_a70,1);
_a6b(_a6d,_a6f);
}
};
function _a6b(_a71,_a72,_a73){
var opts=$.data(_a71,"combobox").options;
var _a74=$(_a71).combo("panel");
if(!$.isArray(_a72)){
_a72=_a72.split(opts.separator);
}
if(!opts.multiple){
_a72=_a72.length?[_a72[0]]:[""];
}
var _a75=$(_a71).combo("getValues");
if(_a74.is(":visible")){
_a74.find(".combobox-item-selected").each(function(){
var row=opts.finder.getRow(_a71,$(this));
if(row){
if($.easyui.indexOfArray(_a75,row[opts.valueField])==-1){
...
$.map(_a75,function(v){
if($.easyui.indexOfArray(_a72,v)==-1){
var el=opts.finder.getEl(_a71,v);
if(el.hasClass("combobox-item-selected")){
el.removeClass("combobox-item-selected");
opts.onUnselect.call(_a71,opts.finder.getRow(_a71,v));
}
}
});
var _a76=null;
...
var v=_a72[i];
var s=v;
var row=opts.finder.getRow(_a71,v);
if(row){
...
opts.onSelect.call(_a71,row);
}
}else{
s=_a77(v,opts.mappingRows)||v;
}
vv.push(v);
ss.push(s);
}
if(!_a73){
$(_a71).combo("setText",ss.join(opts.separator));
}
if(opts.showItemIcon){
var tb=$(_a71).combobox("textbox");
tb.removeClass("textbox-bgicon "+opts.textboxIconCls);
if(_a76&&_a76.iconCls){
tb.addClass("textbox-bgicon "+_a76.iconCls);
opts.textboxIconCls=_a76.iconCls;
}
}
$(_a71).combo("setValues",vv);
_a74.triggerHandler("scroll");
function _a77(_a78,a){
var item=$.easyui.getArrayItem(a,opts.valueField,_a78);
return item?item[opts.textField]:undefined;
};
};
function _a79(_a7a,data,_a7b){
var _a7c=$.data(_a7a,"combobox");
var opts=_a7c.options;
_a7c.data=opts.loadFilter.call(_a7a,data);
opts.view.render.call(opts.view,_a7a,$(_a7a).combo("panel"),_a7c.data);
var vv=$(_a7a).combobox("getValues");
$.easyui.forEach(_a7c.data,false,function(row){
if(row["selected"]){
...
_a6b(_a7a,vv.length?[vv[vv.length-1]]:[],_a7b);
}
opts.onLoadSuccess.call(_a7a,data);
};
function _a7d(_a7e,url,_a7f,_a80){
var opts=$.data(_a7e,"combobox").options;
if(url){
opts.url=url;
}
_a7f=$.extend({},opts.queryParams,_a7f||{});
if(opts.onBeforeLoad.call(_a7e,_a7f)==false){
return;
}
opts.loader.call(_a7e,_a7f,function(data){
_a79(_a7e,data,_a80);
},function(){
opts.onLoadError.apply(this,arguments);
});
};
function _a81(_a82,q){
...
if(opts.mode=="remote"){
_a85(qq);
_a7d(_a82,null,{q:q},true);
}else{
var _a86=$(_a82).combo("panel");
_a86.find(".combobox-item-hover").removeClass("combobox-item-hover");
_a86.find(".combobox-item,.combobox-group").hide();
var data=_a83.data;
var vv=[];
$.map(qq,function(q){
q=$.trim(q);
...
for(var i=0;i<data.length;i++){
var row=data[i];
if(opts.filter.call(_a82,q,row)){
var v=row[opts.valueField];
var s=row[opts.textField];
var g=row[opts.groupField];
var item=opts.finder.getEl(_a82,v).show();
...
if(opts.groupField&&_a88!=g){
opts.finder.getGroupEl(_a82,g).show();
_a88=g;
}
}
}
...
function _a85(vv){
if(opts.reversed){
_a84.addClass("combobox-item-hover");
}else{
_a6b(_a82,opts.multiple?(q?vv:[]):vv,true);
}
};
};
function _a89(_a8a){
...
var _a8b=t.combobox("panel");
var item=_a8b.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_a8a,item);
var _a8c=row[opts.valueField];
if(opts.multiple){
if(item.hasClass("combobox-item-selected")){
t.combobox("unselect",_a8c);
}else{
t.combobox("select",_a8c);
}
}else{
t.combobox("select",_a8c);
}
...
function _a8d(_a8e){
var _a8f=$.data(_a8e,"combobox");
var opts=_a8f.options;
$(_a8e).addClass("combobox-f");
$(_a8e).combo($.extend({},opts,{onShowPanel:function(){
$(this).combo("panel").find("div.combobox-item:hidden,div.combobox-group:hidden").show();
_a6b(this,$(this).combobox("getValues"),true);
$(this).combobox("scrollTo",$(this).combobox("getValue"));
opts.onShowPanel.call(this);
}}));
var p=$(_a8e).combo("panel");
p.unbind(".combobox");
for(var _a90 in opts.panelEvents){
p.bind(_a90+".combobox",{target:_a8e},opts.panelEvents[_a90]);
}
};
function _a91(e){
...
}}),panelEvents:{mouseover:_a91,mouseout:_a92,click:_a93,scroll:_a96},filter:function(q,row){
var opts=$(this).combobox("options");
...
var _ac5=(p instanceof $)?p.attr("id").substr(_ac4.itemIdPrefix.length+1):_a5a(_ac3,p);
...
var now=new Date();
$(_bb8).datebox("calendar").calendar({year:now.getFullYear(),month:now.getMonth()+1,current:new Date(now.getFullYear(),now.getMonth(),now.getDate())});
_ba5(_bb8);
}},{text:function(_bb9){
return $(_bb9).datebox("options").closeText;
},handler:function(_bba){
...
(function($){
function _bbb(_bbc){
var _bbd=$.data(_bbc,"datetimebox");
var opts=_bbd.options;
$(_bbc).datebox($.extend({},opts,{onShowPanel:function(){
var _bbe=$(this).datetimebox("getValue");
_bc4(this,_bbe,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_bbc).removeClass("datebox-f").addClass("datetimebox-f");
$(_bbc).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_bbd.spinner){
var _bbf=$(_bbc).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_bbf.children("div.datebox-calendar-inner"));
_bbd.spinner=p.children("input");
}
_bbd.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator});
$(_bbc).datetimebox("initValue",opts.value);
};
function _bc0(_bc1){
var c=$(_bc1).datetimebox("calendar");
var t=$(_bc1).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _bc2(_bc3,q){
_bc4(_bc3,q,true);
};
function _bc5(_bc6){
var opts=$.data(_bc6,"datetimebox").options;
var date=_bc0(_bc6);
_bc4(_bc6,opts.formatter.call(_bc6,date));
$(_bc6).combo("hidePanel");
};
function _bc4(_bc7,_bc8,_bc9){
var opts=$.data(_bc7,"datetimebox").options;
$(_bc7).combo("setValue",_bc8);
if(!_bc9){
if(_bc8){
var date=opts.parser.call(_bc7,_bc8);
$(_bc7).combo("setText",opts.formatter.call(_bc7,date));
$(_bc7).combo("setValue",opts.formatter.call(_bc7,date));
}else{
$(_bc7).combo("setText",_bc8);
}
}
var date=opts.parser.call(_bc7,_bc8);
$(_bc7).datetimebox("calendar").calendar("moveTo",date);
$(_bc7).datetimebox("spinner").timespinner("setValue",_bca(date));
function _bca(date){
function _bcb(_bcc){
return (_bcc<10?"0":"")+_bcc;
};
var tt=[_bcb(date.getHours()),_bcb(date.getMinutes())];
if(opts.showSeconds){
tt.push(_bcb(date.getSeconds()));
}
return tt.join($(_bc7).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_bcd,_bce){
if(typeof _bcd=="string"){
var _bcf=$.fn.datetimebox.methods[_bcd];
if(_bcf){
return _bcf(this,_bce);
}else{
return this.datebox(_bcd,_bce);
}
}
_bcd=_bcd||{};
return this.each(function(){
var _bd0=$.data(this,"datetimebox");
if(_bd0){
$.extend(_bd0.options,_bcd);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_bcd)});
}
_bbb(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _bd1=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_bd1.originalValue,disabled:_bd1.disabled,readonly:_bd1.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_bd2){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _bd3=opts.value;
if(_bd3){
_bd3=opts.formatter.call(this,opts.parser.call(this,_bd3));
}
$(this).combo("initValue",_bd3).combo("setText",_bd3);
});
},setValue:function(jq,_bd4){
return jq.each(function(){
_bc4(this,_bd4);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_bd5){
var t=$(_bd5);
return $.extend({},$.fn.datebox.parseOptions(_bd5),$.parser.parseOptions(_bd5,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_bc2(this,q);
}},buttons:[{text:function(_bd6){
return $(_bd6).datetimebox("options").currentText;
},handler:function(_bd7){
var opts=$(_bd7).datetimebox("options");
_bc4(_bd7,opts.formatter.call(_bd7,new Date()));
$(_bd7).datetimebox("hidePanel");
}},{text:function(_bd8){
return $(_bd8).datetimebox("options").okText;
},handler:function(_bd9){
_bc5(_bd9);
}},{text:function(_bda){
return $(_bda).datetimebox("options").closeText;
},handler:function(_bdb){
$(_bdb).datetimebox("hidePanel");
}}],formatter:function(date){
var h=date.getHours();
var M=date.getMinutes();
var s=date.getSeconds();
function _bdc(_bdd){
return (_bdd<10?"0":"")+_bdd;
};
var _bde=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_bdc(h)+_bde+_bdc(M);
...
var tt=dt[1].split(_bdf);
var hour=parseInt(tt[0],10)||0;
var _be0=parseInt(tt[1],10)||0;
var _be1=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_be0,_be1);
}});
})(jQuery);
(function($){
function init(_be2){
var _be3=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_be2);
var t=$(_be2);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_be3.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_be3.bind("_resize",function(e,_be4){
if($(this).hasClass("easyui-fluid")||_be4){
_be5(_be2);
}
return false;
});
...
function _be5(_be6,_be7){
var _be8=$.data(_be6,"slider");
var opts=_be8.options;
var _be9=_be8.slider;
if(_be7){
if(_be7.width){
opts.width=_be7.width;
}
if(_be7.height){
opts.height=_be7.height;
}
}
_be9._size(opts);
if(opts.mode=="h"){
_be9.css("height","");
_be9.children("div").css("height","");
}else{
_be9.css("width","");
_be9.children("div").css("width","");
_be9.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_be9._outerHeight());
}
_bea(_be6);
};
function _beb(_bec){
var _bed=$.data(_bec,"slider");
...
_bef(aa);
function _bef(aa){
var rule=_bee.find("div.slider-rule");
var _bf0=_bee.find("div.slider-rulelabel");
rule.empty();
_bf0.empty();
for(var i=0;i<aa.length;i++){
var _bf1=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_bf1);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_bf0);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_bf1,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_bf1,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _bf2(_bf3){
var _bf4=$.data(_bf3,"slider");
var opts=_bf4.options;
var _bf5=_bf4.slider;
_bf5.removeClass("slider-h slider-v slider-disabled");
_bf5.addClass(opts.mode=="h"?"slider-h":"slider-v");
_bf5.addClass(opts.disabled?"slider-disabled":"");
var _bf6=_bf5.find(".slider-inner");
_bf6.html("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_bf6.append("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_bf5.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_bf4.isDragging=true;
opts.onSlideStart.call(_bf3,opts.value);
},onStopDrag:function(e){
_bf8(opts.mode=="h"?e.data.left:e.data.top,this);
opts.onSlideEnd.call(_bf3,opts.value);
opts.onComplete.call(_bf3,opts.value);
_bf4.isDragging=false;
}});
_bf5.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_bf4.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_bf8(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_bf3,opts.value);
});
function _bf8(pos,_bf9){
var _bfa=_bfb(_bf3,pos);
var s=Math.abs(_bfa%opts.step);
if(s<opts.step/2){
_bfa-=s;
}else{
_bfa=_bfa-s+opts.step;
}
if(opts.range){
var v1=opts.value[0];
var v2=opts.value[1];
...
if(_bf9){
var _bfc=$(_bf9).nextAll(".slider-handle").length>0;
if(_bfa<=v2&&_bfc){
v1=_bfa;
}else{
if(_bfa>=v1&&(!_bfc)){
...
_bfa<m?v1=_bfa:v2=_bfa;
}
}
}
$(_bf3).slider("setValues",[v1,v2]);
}else{
$(_bf3).slider("setValue",_bfa);
}
};
};
function _bfd(_bfe,_bff){
var _c00=$.data(_bfe,"slider");
var opts=_c00.options;
var _c01=_c00.slider;
var _c02=$.isArray(opts.value)?opts.value:[opts.value];
var _c03=[];
if(!$.isArray(_bff)){
_bff=$.map(String(_bff).split(opts.separator),function(v){
return parseFloat(v);
});
}
_c01.find(".slider-value").remove();
var name=$(_bfe).attr("sliderName")||"";
for(var i=0;i<_bff.length;i++){
var _c04=_bff[i];
if(_c04<opts.min){
_c04=opts.min;
}
...
var _c05=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_c01);
_c05.attr("name",name);
_c05.val(_c04);
_c03.push(_c04);
var _c06=_c01.find(".slider-handle:eq("+i+")");
var tip=_c06.next();
var pos=_c07(_bfe,_c04);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_bfe,_c04));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _c08="left:"+pos+"px;";
_c06.attr("style",_c08);
tip.attr("style",_c08+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _c08="top:"+pos+"px;";
_c06.attr("style",_c08);
tip.attr("style",_c08+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?_c03:_c03[0];
$(_bfe).val(opts.range?_c03.join(opts.separator):_c03[0]);
if(_c02.join(",")!=_c03.join(",")){
opts.onChange.call(_bfe,opts.value,(opts.range?_c02:_c02[0]));
}
};
function _bea(_c09){
var opts=$.data(_c09,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_bfd(_c09,opts.value);
opts.onChange=fn;
};
function _c07(_c0a,_c0b){
var _c0c=$.data(_c0a,"slider");
var opts=_c0c.options;
var _c0d=_c0c.slider;
var size=opts.mode=="h"?_c0d.width():_c0d.height();
var pos=opts.converter.toPosition.call(_c0a,_c0b,size);
if(opts.mode=="v"){
pos=_c0d.height()-pos;
}
if(opts.reversed){
...
function _bfb(_c0e,pos){
var _c0f=$.data(_c0e,"slider");
var opts=_c0f.options;
var _c10=_c0f.slider;
var size=opts.mode=="h"?_c10.width():_c10.height();
var pos=opts.mode=="h"?(opts.reversed?(size-pos):pos):(opts.reversed?pos:(size-pos));
var _c11=opts.converter.toValue.call(_c0e,pos,size);
return _c11.toFixed(0);
};
$.fn.slider=function(_c12,_c13){
if(typeof _c12=="string"){
return $.fn.slider.methods[_c12](this,_c13);
}
_c12=_c12||{};
return this.each(function(){
var _c14=$.data(this,"slider");
if(_c14){
$.extend(_c14.options,_c12);
}else{
_c14=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_c12),slider:init(this)});
$(this).removeAttr("disabled");
}
...
_bfd(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
...
$.fn.slider.parseOptions=function(_c18){
var t=$(_c18);
return $.extend({},$.parser.parseOptions(_c18,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_c19){
return _c19;
},converter:{toPosition:function(_c1a,size){
var opts=$(this).slider("options");
return (_c1a-opts.min)/(opts.max-opts.min)*size;
},toValue:function(pos,size){
var opts=$(this).slider("options");
return opts.min+(opts.max-opts.min)*(pos/size);
}},onChange:function(_c1b,_c1c){
},onSlideStart:function(_c1d){
},onSlideEnd:function(_c1e){
},onComplete:function(_c1f){
}};
})(jQuery);
